...
class TestQueryTypes(unittest.TestCase):
    ...
    def test_query_types(self):
        ...
        queries = [
            ...
            ("perseus", '"cum clamore"', (2, 3, 1)),
            ("perseus", '"cum <clamor>"', (3, 3, 1)),
            ("perseus", '"cum <clamor>|ABL."', (2, 3, 1)),
            ("perseus", '"cum magno" <calor>', (1, 3, 1)),
            ("perseus", '"deceptus <amor>|ABL.SG."', (1, 3, 1)),
            ("lasla", '":VB. milites"', (8, 2, 1)),
            ("lasla", '":VB. <miles>"', (10, 2, 1)),
            ("perseus", "</::bellum>", (8, 3, 1)),
            ("lasla", "[!::en?cowardice]", (242, 2, 1)),
