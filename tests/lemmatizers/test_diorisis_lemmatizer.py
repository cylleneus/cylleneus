...
class TestDiorisisLemmatizer(unittest.TestCase):
    """Tests for `cylleneus` package."""
    ...
    def test_diorisis_tokenizer(self):
        ...
        from cylleneus.corpus.grk.diorisis.filters import CachedLemmaFilter
        ...
        T = Tokenizer()
        L = CachedLemmaFilter()
        for t in L(T(doc, docix=0, mode="index"), mode="index", cached=False):
            assert t
