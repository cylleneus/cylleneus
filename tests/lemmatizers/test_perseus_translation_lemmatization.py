...
class TestPerseusTranslationLemmatization(unittest.TestCase):
    ...
    def test_perseus_json_tokenizer(self):
        ...
        from translation.corpus.perseus_translation.tokenizer import (
            CachedTokenizer,
        )
        from translation.corpus.perseus_translation.filters import (
            CachedLemmaFilter,
        )
        ...
        for t in lemmas(
            tokens({"text": doc, "meta": meta}, docix=0, mode="index")
        ):
            print(t)
