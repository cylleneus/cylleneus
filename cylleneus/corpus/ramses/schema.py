...
from cylleneus.engine.analysis.filters import CachedSynsetFilter, AnnotationFilter, SemfieldFilter, CaseFilter, \
    MappingFilter
...
class DocumentSchema(BaseSchema):
    ...
    mapping = MAPPING(analyzer=Tokens | Mappings, vector=True)
